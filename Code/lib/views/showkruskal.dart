...
class ShowKruskal extends StatefulWidget {
  ShowKruskal({Key key, this.title, this.vertex}) : super(key: key);
  final String title;
  final int vertex;
  @override
  _ShowKruskalState createState() {
...
class _ShowKruskalState extends State<ShowKruskal> {
  @override
  void initState() {
    super.initState();
    setStackWidgets();
  ...
  kruskalButton() { // button to calculate mst using Kruskal
    return Padding(
  ...
  Future<void> kruskalMST() async {
    ...
    while (edgeCount < vertexes - 1) {
      ...
      edgeCount++;
      print(a.toString() + " " + b.toString() + " " + min.toString());
      Offset p1, p2;
      union1(a, b);
